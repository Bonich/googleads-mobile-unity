...
namespace GoogleMobileAds.Android.Mediation.Fyber
{
    ...
    {
        private static FyberClient instance = new FyberClient();
        private FyberClient() { }
        ...
        {
            AndroidJavaClass inneractiveAdManager = new AndroidJavaClass("com.fyber.inneractive.sdk.external.InneractiveAdManager");
